...
- Race attempt timer (default 30 min); Co-op TimeKeeper uses `snake_timeKeeper_coop` only  
...
Race: `SCORE_PULSE`, `ATTEMPT_*`, `BOARD_DELTA`, `SPECTATE_FOCUS`, …  
...
- `src/` — multiplayer JS (net, session, race, coop, ui)
...
- [x] Race focus + **mosaic** multi-board spectator UI
...
- Connections / room: **30**
- Race players: **10** · Co-op players: **4**
- Default Race duration: **30** minutes
